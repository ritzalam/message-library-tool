...
var listEvents = {
	    ...
	    3 : 'create_meeting_request', //ok
	    4 : 'create_meeting_response', //ok
	    5 : 'meeting_created_event',   //ok
	    6 : 'end_meeting_request',	//ok
	    7 : 'end_meeting_response',	//ok
	    8 : 'end_meeting_warning_event',//ok
	    9 : 'meeting_ended_event',	//ok
	    10: 'register_user_request',//ok
	    11: 'register_user_response',//ok
	    12: 'user_registered_event',//ok
	    13: 'user_join_request',//ok
	    14: 'user_join_response',//ok
	    15: 'user_joined_event', //ok
	    
	    16: 'user_leave_event',//ok
	    17: 'user_left_event',//ok
	    18: 'get_users_request',//ok
	    19: 'get_users_response',//check again
	    20: 'raise_user_hand_request',//ok
		21: 'user_raised_hand_event',//ok
		22: 'assign_presenter_request',//ok
		23: 'presenter_assigned_event',//ok
		24: 'mute_user_request',//ok
		25: 'mute_user_request_event',//ok
		26: 'mute_voice_user_request',//ok but - to _
		27: 'voice_user_muted_event',//ok but - to _
		28: 'user_muted_event',//ok
		29: 'user_publish_stream_request',//ok
		30: 'publish_stream_request',//ok
		31: 'publish_stream_response',//ok
		32: 'user_publish_stream_response',//ok
		33: 'published_stream_event',//ok
		34: 'user_published_stream_event',//ok
		35: 'unpublished_stream_event',//ok
		36: 'user_unpublished_stream_event',//ok
		37: 'public_chat_message_event',//ok
		38: 'broadcast_public_chat_message_event',//ok
		39: 'private_chat_message_event',//ok
		40: 'broadcast_private_chat_message_event',//ok
		41: 'broadcast_whiteboard_draw_event',//ok
		42: 'broadcast_whiteboard_update_event',//ok
		43: 'whiteboard_cursor_event',//ok
		44: 'broadcast_whiteboard_cursor_event',//ok
		45: 'share_presentation_event',//ok
		46: 'broadcast_share_presentation_event',//ok
		47: 'resize_and_move_page_presentation_event',//ok
		48: 'broadcast_resize_and_move_page_presentation_event'//ok
};	

function returnJsonOf(event_type) {
    ...
    case "whiteboard_draw_event":
        ...
        sectionBy = {};
        sectionBy.id = userID;
        sectionBy.name = userName;
        payload.by = sectionBy;
        temp = {};
        temp.header = header;
    ...
    case "create_meeting_request":
	    ...
	    var a = {"number":"613-520-7600", "description":"Ottawa"};
	    var b = {"number":"1-888-555-7890", "description":"NA Toll-Free"};
	...
	/*case "whiteboard_draw_update_event":

        var event_name = "whiteboard_draw_update_event";
        var source_of_event = "bbb-apps";
